...
let user = {
  ...
  dateOfBirth: "22nd January, 2000",
  blogs: [
    { title: "what a man can do vs what a woman can do", likes: 30 },
    { title: "the differences between man and boy", likes: 50 },
  ],
  location: "Nigeria",
  login: () => {
...
// random numbers
const mathEx = Math.random();
console.log(mathEx);
console.log(Math.round(mathEx * 100));
